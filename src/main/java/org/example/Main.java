...
class Main {
    static Book[] bookList = {
            new Book(1, "Harry Potter", "J.K. Rowling", "Fantasy"),
            new Book(2, "Lord of the Rings", "J.R.R. Tolkien", "Fantasy"),
    ...
    String inputNim() {
        ...
        while (true) {
            ...
            if (nim.length() == 15) {
                ...
                System.out.println("Masukkan NIM (Harus 15 angka). Silakan coba lagi.");
            }
        }
    }
